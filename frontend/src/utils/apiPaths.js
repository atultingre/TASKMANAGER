...
export const API_PATHS = {
  ...
  TASKS: {
    ...
    UPDATE_TASK_STATUS: (taskId) => `/api/tasks/${taskId}/status`, // Update a task status
    UPDATE_TODO_CHECKLIST: (taskId) => `/api/tasks/${taskId}/todo`, // Update a task checklist
  },

  REPORTS: {
    EXPORT_TASKS: "/api/reports/exports/tasks", // Download all tasks as an Excel
    EXPORT_USERS: "/api/reports/exports/usres", // Download user-tasks as an Excel
  },
